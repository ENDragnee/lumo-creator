  ...
  },
  {
    ...
    widgets: [
      ...
      },
      {
        ...
        label: "Simulation",
        component: <div>Simulation Widget</div>,
      },
    ],
  },
  // {
        ...
        <div className="p-3 space-y-6">
          {filteredCategories.map((category, index) => (
            <div key={index} className="space-y-2">
              {!isCollapsed && (
                <h3 className="text-xs font-semibold text-[#8E8E93] px-2">
                  {category.name}
                </h3>
              )}
...
function WidgetButton({
  ...
  return (
    ...
    >
      <Button variant="ghost" className="w-full h-full justify-start" asChild>
        <div>
